...
{{-- USER DEFINED SCRIPT --}}
<script src="{{ URL::to('assets/js/chart.min.js') }}" crossorigin="anonymous" defer=""></script>
<script src="{{ URL::to('assets/demo/chart-area-demo.js') }}" crossorigin="anonymous" defer=""></script>
<script src="{{ URL::to('assets/demo/chart-bar-demo.js') }}" crossorigin="anonymous" defer=""></script>
<script src="{{ URL::to('assets/demo/chart-pie-demo.js') }}" crossorigin="anonymous" defer=""></script>
<script src="{{ URL::to('assets/js/scripts.js') }}" crossorigin="anonymous" defer=""></script>
</head>
