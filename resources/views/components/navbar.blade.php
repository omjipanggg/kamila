<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <button class="btn btn-sm btn-link me-4 me-lg-0 px-3 btn-nav" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
    <a class="navbar-brand" href="{{ URL::to('/') }}">Kamila</a>
