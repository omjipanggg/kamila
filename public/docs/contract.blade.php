...
<head>
	...
	<title>PKWT&mdash;{{ $data['name'] }}</title>
	<style>
		*, *::before, *::after {
			font-family: 'Tahoma';
			margin: 0;
...
/*			position: relative;		*/
		...
		table.schedule td:first-child { padding-right: .5rem; }
		table.schedule td:nth-child(2) { padding-right: 2rem; }
		table.schedule td:nth-child(3) { padding-right: .25rem; }
...
<body>
	<div class="container">
		...
		{{-- <img src="{{ asset('img/base.jpg') }}" alt="Head" class="floated"> --}}
		...
		<div class="page" id="page">
			...
			<section id="chapterZero">
				...
				<div class="d-flex">
				<p class="rome bold">I.</p><p class="pb-1 text-justify"><strong>PT KINARYA ALIHDAYA MANDIRI,</strong> yang didirikan berdasarkan Akta Pendirian Nomor: 08 tanggal 05 April 2012 yang telah mendapat pengesahan dari Menteri Hukum dan Hak Asasi Manusia Nomor: AHU-20511.AH.01.01 Tahun 2012 tanggal 20 April 2012 dengan akta perubahan terakhir Akta Pernyataan Keputusan Rapat PT Kinarya Alihdaya Mandiri Nomor: 05 Tanggal 11 Agustus 2022, yang dalam perbuatan hukum ini secara sah diwakili oleh <strong>Ariadi Nuratmojo</strong> sebagai Direktur yang selanjutnya dalam perjanjian ini disebut <strong>PIHAK PERTAMA</strong>.</p>
				</div>
				<div class="group">
				<span class="rome bold">II.</span>
				<table class="text">
					<tr>
						<td>Nama</td>
						<td>:</td>
				...
				<p class="text-justify ps-15 pb-1">Dalam hal ini bertindak untuk dan atas nama diri sendiri, selanjutnya dalam perjanjian ini disebut <strong>PIHAK KEDUA.</strong></p>
				</div>
			...
			<section id="chapterOne">
				...
				<ol class="ps-1 pb-1 article-list">
					<li>PIHAK PERTAMA memberikan tugas tanggungjawab pekerjaan kepada PIHAK KEDUA sebagaimana PIHAK KEDUA menerima penugasan pekerjaan tersebut yang berasal dari MITRA untuk dilaksanakan dengan sebaik-baiknya sebagai:
						<ol type="a">
							<li><span class="w-5">Posisi/Jabatan</span>: <strong>DATA</strong></li>
							<li><span class="w-5">Dept./Unit Kerja</span>: <strong>DATA</strong></li>
							<li><span class="w-5">Nama mitra</span>: <strong>DATA</strong></li>
							<li><span class="w-5">Lokasi kerja</span>: <strong>DATA</strong></li>
						</ol>
					</li>
			...
			<section id="chapterFour">
				...
				<ol class="ps-1 pb-1 article-list">
					...
					<li>PIHAK PERTAMA dapat melakukan penjadwalan kerja khusus (kerja bergilir dan/atau kerja shift) kepada PIHAK KEDUA selain ketentuan waktu kerja yang ditetapkan dalam ayat (1) Pasal ini, dengan tetap memperhatikan ketentuan maksimal kerja dalam seminggu dan waktu istirahat dan/atau libur, minimal 1 (Satu) hari dalam seminggu.</li>
			...
			<section id="chapterFive">
				...
				<ol class="ps-1 pb-1 article-list">
					<li>Atas pekerjaan yang dilakukan oleh PIHAK KEDUA, PIHAK KEDUA berhak mendapat upah bulanan dari PIHAK PERTAMA sebesar <strong>DATA</strong> dengan rincian sebagai berikut:
						<ol type="a">
							<li><span class="w-5">Gaji Pokok</span>: <strong>DATA</strong></li>
							<li><span class="w-5">Tunjangan Tetap</span>: <strong>DATA</strong></li>
						</ol>
					</li>
			...
			<section id="chapterSeven">
				...
				<ol class="ps-1 pb-1 article-list">
					...
					<div class="img-wrap">
						{{-- <img src="{{ asset('img/mangkir.png') }}" alt="Mangkir"> --}}
					</div>
